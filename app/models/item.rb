class Item < ActiveRecord::Base
  ...
  has_many :plugin_specific_items, :foreign_key => :record_id
  #has_one :plugin_generice_item, :foreign_key => :record_id
  def plugin_generice_item
    PluginGenericItem.find_by_record_id self.id
  end
