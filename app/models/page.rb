class Page < ActiveRecord::Base
  NAME_CATEGORY_COLUMN = "category_column"
  NAME_WEBSITE_BOTTOM = "website_bottom"
  NAME_WEBSITE_TOP = "website_top"
  NAME_HOMEPAGE_SIDEBAR = "homepage_sidebar"
  NAME_EMAIL_FOOTER="email_footer"
